...
BA::BA(int setID, const char* setFName, const char* setLName, int setNumCourses, int* setGrades)
	: Student(setID, setFName, setLName, setNumCourses), gradesSize(setNumCourses), grades(new int[gradesSize]) {
...
string BA::studType() const { return "BA"; } // virtual function
